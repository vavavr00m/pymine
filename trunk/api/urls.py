...
urlpatterns += patterns('',
                        (r'^comment/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w*)\.(?P<fmt>(json|xml|txt|rdr))$',
                        ...
                        (r'^feed/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w*)\.(?P<fmt>(json|xml|txt|rdr))$',
                        ...
                        (r'^item/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w*)\.(?P<fmt>(json|xml|txt|rdr))$',
                        ...
                        (r'^tag/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w*)\.(?P<fmt>(json|xml|txt|rdr))$',
                        ...
                        (r'^vurl/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w*)\.(?P<fmt>(json|xml|txt|rdr))$',
