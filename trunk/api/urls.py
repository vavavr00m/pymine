...
urlpatterns += patterns('',
			(r'^comment/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w{0,127})\.(?P<fmt>(json|xml|txt|rdr))$',
			...
			(r'^tag/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w{0,127})\.(?P<fmt>(json|xml|txt|rdr))$',
			...
			(r'^vurl/(?P<id>[1-9]\d*)/(?P<attr>\$?[_A-Za-z]\w{0,127})\.(?P<fmt>(json|xml|txt|rdr))$',
