...
urlpatterns = patterns('',
                       ...
                       (r'^tag/(?P<tid>\d+)/key/(?P<key>\w+).(?P<fmt>(xml|json|py))$', API_CALL,
                       ...
                       (r'^tag.(?P<fmt>(xml|json|py))$', API_CALL,
                        {'GET': api.read_tag_list, 'POST': api.create_tag}),
                       ...
                       (r'^relation/(?P<rid>\d+)/key/(?P<key>\w+).(?P<fmt>(xml|json|py))$', API_CALL,
                       ...
                       (r'^relation.(?P<fmt>(xml|json|py))$', API_CALL,
                        {'GET': api.read_relation_list, 'POST': api.create_relation}),
                       (r'^registry/key/(?P<key>\w+).(?P<fmt>(xml|json|py))$', API_CALL,
                        {'DELETE': api.delete_registry_key, 'GET': api.get_registry_key}),
                       (r'^registry.(?P<fmt>(xml|json|py))$', API_CALL,
                        {'GET': api.read_registry, 'POST': api.update_registry}),
                       (r'^item/(?P<iid>\d+)/key/(?P<key>\w+).(?P<fmt>(xml|json|py))$', API_CALL,
                        {'DELETE': api.delete_item_key, 'GET': api.get_item_key}),
                       (r'^item/(?P<iid>\d+)/comment.(?P<fmt>(xml|json|py))$', API_CALL,
                        {'GET': api.read_comment_list, 'POST': api.create_comment}),
                       (r'^item/(?P<iid>\d+)/clone.(?P<fmt>(xml|json|py))$', API_CALL,
                        {'GET': api.read_clone_list, 'POST': api.create_clone}),
                       (r'^item/(?P<iid>\d+)/(?P<cid>\d+)/key/(?P<key>\w+).(?P<fmt>(xml|json|py))$', API_CALL,
                        {'DELETE': api.delete_comment_key, 'GET': api.get_comment_key}),
                       (r'^item/(?P<iid>\d+)/(?P<cid>\d+).(?P<fmt>(xml|json|py))$', API_CALL,
