...
get    GET    /r/VURLKEY                     redirect-vurlkey # short to long remapping
get    GET    /v/SUFFIX                      redirect-vurlname # long to long remapping

ie     GET    /ie                            root-ie
ie     GET    /ie/export                     ie-export
ie     GET    /ie/import                     ie-import
