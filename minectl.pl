...
list-comments            PASSARGS   read    /api/item/IID/comment.json
create-comment           PASSARGS   create  /api/item/IID/comment.json                   commentKey=value ...
get-comment              SUB2PASS   read    /api/item/IID/comment/CID.json               42
delete-comment           SUBEVERY   delete  /api/item/IID/comment/CID.json               42 27 23 ...
update-comment           SUB2PASS   create  /api/item/IID/comment/CID/key.json           42 commentKey=value ...
get-comment-key          SUB2EVERY  read    /api/item/IID/comment/CID/key/KEY.json       42 commentKey
delete-comment-key       SUB2EVERY  delete  /api/item/IID/comment/CID/key/KEY.json       42 commentKey ...
